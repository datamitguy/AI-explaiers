...
| `leadership.html` | **Big Ideas, Part 6: Leadership & management**: 22 leadership theories and 22 management theories (OKRs, goal-setting, Deming, lean, Team Topologies and more), with 6 simulations |
...
## Big Ideas, Part 6: Leadership & management (`leadership.html`)
...
| **Management** | OKRs (score an OKR 🎮), goal-setting theory, management by objectives, North Star and input metrics, the balanced scorecard, scientific management (Taylor), Fayol's functions, the Hawthorne studies (and their reanalysis), what managers really do (Mintzberg), mechanistic vs. organic organisations, span of control (how many layers? 🎮), McKinsey 7-S, Deming and the red bead experiment 🎮, lean and the Toyota Production System, the learning organisation, leading change (Lewin, Kotter), forced ranking, Team Topologies, self-management (holacracy, teal), the effective executive (Drucker), evidence-based hiring, and the World Management Survey |
